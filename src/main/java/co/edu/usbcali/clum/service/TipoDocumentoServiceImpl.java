...
public class TipoDocumentoServiceImpl implements TipoDocumentoService {
    ...
    */
    ...
    public List<TipoDocumento> getTipoDocumento() throws Exception {
        ...
        try {
            list = tipoDocumentoRepository.findAll();
        } catch (Exception e) {
    ...
    public void saveTipoDocumento(TipoDocumento entity)
        ...
        try {
            ...
            if (getTipoDocumento(entity.getTipoDocumentoId()) != null) {
    ...
    public void deleteTipoDocumento(TipoDocumento entity)
        ...
        if (entity.getTipoDocumentoId() == null) {
            throw new ZMessManager().new EmptyFieldException("tipoDocumentoId");
        }

        List<Tercero> terceros = null;

        try {
            terceros = terceroRepository.findByProperty("tipoDocumento.tipoDocumentoId",
            ...
            tipoDocumentoRepository.deleteById(entity.getTipoDocumentoId());
    ...
    public void updateTipoDocumento(TipoDocumento entity)
        ...
        try {
            ...
            tipoDocumentoRepository.update(entity);
    ...
    public TipoDocumento getTipoDocumento(Integer tipoDocumentoId)
        ...
        try {
            if (tipoDocumentoRepository.findById(tipoDocumentoId).isPresent()) {
                entity = tipoDocumentoRepository.findById(tipoDocumentoId).get();
            }
        } catch (Exception e) {
    ...
    public List<TipoDocumento> findPageTipoDocumento(String sortColumnName,
        ...
        try {
            entity = tipoDocumentoRepository.findPage(sortColumnName,
    ...
    public Long findTotalNumberTipoDocumento() throws Exception {
        ...
        try {
            entity = tipoDocumentoRepository.count();
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("TipoDocumento Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<TipoDocumento> findByCriteria(Object[] variables,
        ...
        try {
            list = tipoDocumentoRepository.findByCriteria(where);
        } catch (Exception e) {
